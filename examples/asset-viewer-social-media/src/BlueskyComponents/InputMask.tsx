        ...
        <div className="w-full max-w-2xl bg-[#161e27] text-white rounded-xl p-6 shadow-lg">
            <div className="flex items-start space-x-3">
                <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center">
                    <img className="rounded-full" alt="" draggable="false" src="https://cdn.bsky.app/img/avatar_thumbnail/plain/did:plc:mf3v5yiwchlvkrhqrfofdjxn/bafkreif6bim4ci67uw3hymet2x5odo27zh67bee423adimxdi6kuldu4dy@jpeg" />
                </div>
                    ...
                    <div className="border-t border-gray-700 mt-3 pt-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-3">
                                {charCount > 0 && (
                                    <span className="text-sm text-gray-400">{charCount}</span>
                                )}
                                <button
                                    className={`px-4 py-1.5 rounded-full font-bold ${post.length === 0
